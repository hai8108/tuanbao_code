 ...
 */
public class TlcyGallery extends HorizontalScrollView implements OnClickListener {
    Context context;
    int itemWidth = 0;
    ...
    public TlcyGallery(Context context) {
        super(context);
        this.context = context;
    }

    public TlcyGallery(Context context, AttributeSet set) {
        super(context, set);
        this.context = context;
    }

    public TlcyGallery(Context context, AttributeSet set, int style) {
        ...
        if (texts != null) {
            for (int i = 0; i < texts.length; i++) {
                ...
                if (button != null) {
                    ...
                    layout.addView(button, new LinearLayout.LayoutParams(getItemWidth()/*(int) getResources().getDimension(widthDimenId)*/, (int) getResources().getDimension(heightDimenId)));
...
//        }
    ...
    public boolean isScroll() {
        ...
        int btnWidth = getItemWidth()/*(int) getResources().getDimension(widthDimenId)*/;
        WindowManager wm = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE); 
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        for (int i = 0; i < childNum; i++) {
            ...
            if (view != null) {
                view.getLayoutParams().width = getItemWidth()/*(int) getResources().getDimension(widthDimenId)*/;
