...
import com.haitian.model.ItemModel;
...
public class Utils {
    ...
    public static String getIMEI() {
        TelephonyManager tm = (TelephonyManager) com.haitian.main.Application.application.getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getFileRoPath(ItemModel m) {
        return new StringBuffer(Configs.tlcyRoPath).append(String.valueOf(m.type)).append("_").append(String.valueOf(m.id)).append("_").append(buildFileNameandType(m.urlRo)).toString();
    }
    /**
     * /mnt/sdcard/XHPM/music/3_1805_co.txt
     */
    public static String getFileCoPath(ItemModel m) {
        return new StringBuffer(Configs.tlcyCoPath).append(String.valueOf(m.type)).append("_").append(String.valueOf(m.id)).append("_").append(buildFileNameandType(m.url)).toString();
    }
